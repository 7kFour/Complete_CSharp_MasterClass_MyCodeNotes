...
namespace Lambda_Expressions {
    internal class Program {
        ...
        // Lambda expressions provide a simple and more compact functional syntax to
        // write anonymous methods - Lambda is taken from Lambda calculus where everything is
        // expressed in terms of functions
        // Lambda declaration operator => (can be read as 'goes into' or 'goes to')
        // separates the lambdas parameter list from its body

        // Lambdas can have 2 forms 

        // Expression Lambda
        // (input-parameters) => expression

        // Statement Lambda
        // (input-parameters) => { logic goes here...}
        ...
        static void Main(string[] args) {
            ...
            // using a lambda to meet our filter requirement - p is just an argument like a normal method)
            // you can put multiple parameters in () and a single can be with or without () 
            ...
            // p => logic that returns true
            // obviously this could be anything but to meet the signature of the FilterDelegate we created
            // it has to be a person parameter returning a bool
